            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/wrong_no/index">Wrong No</a>
                        </li>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($data)) {
                                            foreach ($data as $value) { ?>
                                                <tr>
                                                    <th scope="row"><a href="<?= base_url() . 'admin/wrong_no/view/' . $value['mid']; ?>"><?= substr($value['name'], 0, 30); ?></a>
                                                    </th>
                                                    <td><?= $value['phone']; ?></td>
                                                    <td><a tabindex="0"
...
<script type="text/javascript">
    function deleteData(id) {
        ...
        if (confirm("Are you sure, You want to delete data ?")) {
            window.location.href = '<?= base_url() . "admin/wrong_no/delete/"; ?>' + id;
