            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/home/index">Dashboard</a>
                        </li>
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="<?= base_url(); ?>admin/home/add"><button type="button" class="btn btn-block btn-primary">Add New</button></a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            foreach ($data as $value) { ?>
                                                <tr>
                                                    ...
                                                    <a tabindex="0"
                                                        ...
                                                        data-content="<div><?= $value['address']; ?></div>">Click</a>
                                                    </td>
                                                    <td><?= $value['cust_address']; ?></td>
                                                    <td><?= substr($value['issue'], 0, 50); ?></td>
                                                      <td><?= $value['from_web']; ?></td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <?php } elseif ($value['status'] == 7) { ?>
                                                            <span class="badge rounded-pill bg-success">Self Visit</span>
                                                        <?php } elseif ($value['status'] == 8) { ?>
                                                            <span class="badge rounded-pill bg-info">Future Option</span>
                                                        <?php } else { ?>
                                                            <?= $value['status']; ?>
                                                        <?php } ?>
                                                    </td>
                                                    <td class="action-items" style="text-align: center;">
                                                        <a href="https://api.whatsapp.com/send?phone=+91<?= $value['phone']; ?>&text=Thanks for reaching out! To provide a Free quote, could you please share the specific model number of your MacBook">
