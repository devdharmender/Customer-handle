...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Not Interested</h1>
                </div>

                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/home/index"><i class="fa-solid fa-house-chimney"></i> Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>admin/not_interested/index">Not Interested</a>
                        </li>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($data)) {
                                            foreach ($data as $value) { ?>
                                                <tr>
                                                    <th scope="row"><a href="<?= base_url() . 'admin/not_interested/view/' . $value['mid']; ?>"><?= substr($value['name'], 0, 30); ?></a>
                                                    </th>
                                                    <td><?= $value['phone']; ?></td>
                                                    <td><a tabindex="0"
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <?php } elseif ($value['status'] == 7) { ?>
                                                            <span class="badge rounded-pill bg-dark">Self Visit</span>
...
<script type="text/javascript">
    function deleteData(id) {
        ...
        if (confirm("Are you sure, You want to delete data ?")) {
            window.location.href = '<?= base_url() . "admin/not_interested/delete/"; ?>' + id;
