                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card card-primary">
                                ...
                                <form action="<?php echo base_url(); ?>admin/home/edit/<?= $editdata['mid']; ?>"
                                    method="post">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="location"
                                                        ...
                                                        value="<?= $editdata['location']; ?>"><?=set_value('location',$editdata['location'])?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control" id="status">
                                                        ...
                                                        <option value="1"
                                                            <?= ($editdata['status'] == 1) ? 'selected' : '' ?>>Follow
                                                            up</option>
                                                        <option value="2"
                                                            <?= ($editdata['status'] == 2) ? 'selected' : '' ?>>
                                                            Appointment</option>
                                                        <option value="3"
                                                            <?= ($editdata['status'] == 3) ? 'selected' : '' ?>>Wrong
                                                            number</option>
                                                        <option value="4"
                                                            <?= ($editdata['status'] == 4) ? 'selected' : '' ?>>No
                                                            response</option>
                                                        <option value="5"
                                                            <?= ($editdata['status'] == 5) ? 'selected' : '' ?>>Not
                                                            interested</option>
                                                        <option value="6"
                                                            <?= ($editdata['status'] == 6) ? 'selected' : '' ?>>Call
                                                            back</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="address" rows="3"
                                                        ...
                                                        value="<?= $editdata['address']; ?>"><?=set_value('address',$editdata['address'])?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
