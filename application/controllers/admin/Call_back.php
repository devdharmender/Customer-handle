...
class Call_back extends CI_Controller
{
    ...
    public function index($page = 1)
    {
        ...
        if ($queryString != '') {
            ...
            $config['base_url'] = base_url('admin/call_back/index');
        ...
        $this->load->view('admin/call-back/list', $data);
    }
    ...
    //         $data['notification'] = $this->app_model->notification('main_table',$data);
    //         $data['notic_rows'] = $this->app_model->notic_rows('main_table',$data);
    //         $this->load->view('admin/call-back/add',$data);
    //     }
    // }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('admin/call-back/edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        if (empty($deletedata)) {
            $this->session->set_flashdata('error', 'Data not Found');
            redirect(base_url() . 'admin/call_back/index');
        }
    ...
    public function view($id)
    {
        ...
        $this->load->view('admin/call-back/user_view',$data);
    }
