...
class Follow_up extends CI_Controller
{
    ...
    public function index($page = 1)
    {
        ...
        if ($queryString != '') {
            ...
            $config['base_url'] = base_url('admin/Follow_up/index');
        ...
        $this->load->view('admin/follow-up/list', $data);
    }
    ...
    //         $data['notification'] = $this->app_model->notification('main_table',$data);
    //         $data['notic_rows'] = $this->app_model->notic_rows('main_table',$data);
    //         $this->load->view('admin/follow-up/add',$data);
    //     }
    // }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('admin/follow-up/edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        if (empty($deletedata)) {
            $this->session->set_flashdata('error', 'Data not Found');
            redirect(base_url() . 'admin/Follow-up/index');
        }
    ...
    public function view($id)
    {
        ...
        $this->load->view('admin/follow-up/user_view',$data);
    }
